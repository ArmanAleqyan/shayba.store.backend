        ...
        <div class="content-wrapper">
            @if(session('added'))
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    <strong>Поздравляю</strong>  Добавление производителя завершено
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div style="display: flex; justify-content: space-between">
                                <h4 class="card-title">Создания производителя</h4>
                            ...
                            <form class="forms-sample" enctype="multipart/form-data" action="{{route('add_new_sub_category')}}" method="post">
                                @csrf
