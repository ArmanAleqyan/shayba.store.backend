...
@section('content')
    <div class="main-panel">
        <div class="content-wrapper">
            ...
            @if(session('updated'))
                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                    <strong>Поздравляю</strong>Редактирование категории завершено
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" enctype="multipart/form-data" action="{{route('update_category')}}" method="post">
                                @csrf
                                <div class="form-group">
                                    ...
                                    <input name="category_id" value="{{$get->id}}" style="display: none" type="text" class="form-control" id="exampleInputName1" placeholder="Название" required>
                                    @if($errors->has('name'))
                                ...
                                <div class="form-group">
                                    <div>
                                        <img style="object-fit: cover; object-position: center; max-height: 200px; max-width: 200px; width: 100%;" src="{{asset('uploads/'.$get->photo)}}" alt="Обязательно выберите фотографию для категории" id="blahas">
                                        <br>
                                        ...
                                        <div style="display: flex; justify-content: space-between">
                                            ...
                                            <br>
                                            <a href="{{route('delete_category', $get->id)}}" class="btn btn-inverse-danger btn-fw">Удалить</a>
                                        </div>
                                    </div>
                                    <br><br><br><br>
                                    <br><br><br>
