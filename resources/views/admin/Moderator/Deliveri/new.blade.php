                                    ...
                                    @foreach($get as $user)
                                        ...
                                        <tr>
                                            ...
                                            <td style="    display: flex;  justify-content: flex-end;">
                                                <a href="@if(auth()->user()->role_id == 4 || auth()->user()->role_id == 1){{route('single_delivery', $user->id)}} @else {{route('SingleNewDelivery', $user->id)}} @endif" class="btn btn-inverse-success btn-fw">Детали</a>
                                            </td>
                                        </tr>
                                        </tbody>
                                    @endforeach
