                ...
                <div class="col-12 grid-margin">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            @if($get->status == 3)
                                <a class="btn btn-inverse-success btn-fw" href="{{route('deliveryd', $get->id)}}">Доставлен</a>
                            @endif
                            @if($get->status == 4)
                                <p class="btn btn-inverse-success btn-fw" >Доставлен</p>
                            @endif

                                @if($get->status == 2)
                                    <a class="btn btn-inverse-success btn-fw" href="{{route('ShowNewShopDetailSuccess', $get->id)}}">Уже в пути</a>
                                @endif
                                @else
                                @if($get->status == 1)
                                    <a class="btn btn-inverse-success btn-fw" href="{{route('success_new_shop', $get->id)}}">Передать в магазины</a>
                                ...
                                @if($get->status == 2)
                                    <a class="btn btn-inverse-success btn-fw" >Ожидаем доставшика</a>
                                @endif
                            @endif
